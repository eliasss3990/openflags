...
public enum EvaluationReason {
    ...
    RESOLVED,
    /** Flag has rules; a {@link io.github.eliasss3990.openflags.core.evaluation.rule.TargetingRule} matched the context. */
    TARGETING_MATCH,
    /** Flag has rules; a {@link io.github.eliasss3990.openflags.core.evaluation.rule.SplitRule} matched the bucket. */
    SPLIT,
    /** Flag has rules; a {@link io.github.eliasss3990.openflags.core.evaluation.rule.MultiVariantRule} matched and a variant was selected. */
    VARIANT,
