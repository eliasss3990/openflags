package io.github.eliasss3990.openflags.core.model;
...
class FlagTest {
    ...
    void constructor_withRules_isImmutable() {
        ...
        List<io.github.eliasss3990.openflags.core.evaluation.rule.Rule> mutable = new java.util.ArrayList<>(List.of(rule));
