 ...
 * under {@code target/classes/io/github/eliasss3990/openflags/core/...} for the constant
...
class NoMicrometerHardClassRefTest {
    ...
    private static final String ALLOWED = "io/github/eliasss3990/openflags/core/metrics/MicrometerMetricsRecorder";
    ...
    private static Path locateClassesRoot() throws Exception {
        ...
        // be the same. We climb to find a directory that holds io/github/eliasss3990/openflags/core.
        Path candidate = p.resolve("io").resolve("github").resolve("eliasss3990")
                .resolve("openflags").resolve("core");
