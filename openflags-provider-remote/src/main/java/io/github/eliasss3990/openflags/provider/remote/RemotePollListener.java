 ...
 * <p>
 * Unlike {@link io.github.eliasss3990.openflags.core.event.FlagChangeListener} (which fires
 * per-flag), this
...
public interface RemotePollListener {
     ...
     * {@link io.github.eliasss3990.openflags.core.event.FlagChangeEvent}s have been emitted.
     *
