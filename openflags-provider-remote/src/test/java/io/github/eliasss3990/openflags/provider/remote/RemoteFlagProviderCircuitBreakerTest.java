...
class RemoteFlagProviderCircuitBreakerTest {
    ...
    void onPollOutcome_invokedWithSuccessAndFailureTags() throws Exception {
        ...
        p.setPollListener(new RemotePollListener() {
            @Override
            public void onPollComplete(Map<String, io.github.eliasss3990.openflags.core.model.Flag> snapshot) {
                // ignored
            }
    ...
    private static final class RecordingMetrics implements io.github.eliasss3990.openflags.core.metrics.MetricsRecorder {
        final AtomicInteger successCount = new AtomicInteger();
        final AtomicInteger failureCount = new AtomicInteger();

        @Override public void recordEvaluation(io.github.eliasss3990.openflags.core.evaluation.EvaluationEvent event) { }
        ...
        @Override public void registerGauge(String name, Iterable<io.github.eliasss3990.openflags.core.metrics.Tag> tags,
