...
class RemoteFlagProviderShutdownTest {
    ...
    void shutdown_transitionsToShutdownState() {
        ...
        assertThat(provider.getState()).isEqualTo(io.github.eliasss3990.openflags.core.provider.ProviderState.READY);

        long before = System.currentTimeMillis();
        provider.shutdown();
        long elapsed = System.currentTimeMillis() - before;

        assertThat(provider.getState()).isEqualTo(io.github.eliasss3990.openflags.core.provider.ProviderState.SHUTDOWN);
